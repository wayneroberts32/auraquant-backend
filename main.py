    ...
    async def emergency_protocol(self):
        ...
        for position_id, position in list(self.positions.items()):
            ...
            result = await self.execute_with_broker(
                position.broker, position.symbol, close_side, position.quantity, position.current_price
            )
...
# >>> MOUNT TELEGRAM WEBHOOK (standalone FastAPI app) <<<
...
# ===== WEBHOOK ENDPOINTS (OTHER INTEGRATIONS) =====
